      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex items-center justify-between  py-6 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden space-x-10 md:flex">
            ...
            <a href="#" className="text-base  text-white font-bold hover:text-gray-900">
              Stories
            </a>
            <a href="#" className="text-base font-bold text-white hover:text-gray-900">
              Map
            </a>
          ...
          <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
            <Link href={`auth/signup`} className="whitespace-nowrap text-base font-extrabold text-white hover:text-gray-900">
              Sign in
            </Link>
            <Link
              href={`auth/login`}
              className="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-transparent px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700"
            >
              Sign up
            </Link>
          </div>
