  ...
  <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
              ...
              <div class="p-5">
                  ...
                  <span class="text-gray-500 dark:text-gray-400">£{listing.price}/month</span>
                  <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">{listing.description.substring(0,50)}</p>
